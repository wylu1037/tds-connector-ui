    ...
    <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{latestMetrics.cpuUsage}%</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{latestMetrics.memoryUsage}%</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{latestMetrics.diskUsage}%</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="text-lg font-semibold">{latestMetrics.activeConnections}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm font-medium">Requests/Min</div>
                    <div className="text-lg font-semibold">{latestMetrics.requestsPerMinute}</div>
                  </div>
                </div>
              </div>
            )}
          ...
          <CardContent>
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {securityAlerts.map((alert) => (
                <div 
                  key={alert.id} 
                  className={`p-3 border rounded-lg ${alert.resolved ? 'bg-muted/50' : ''}`}
                >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Health monitoring for all connected systems</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`font-medium ${
                      connector.responseTime > 300 ? 'text-red-600' : 
                      connector.responseTime > 200 ? 'text-yellow-600' : 
                      'text-green-600'
                    }`}>
